    ...
    <Container id="section-1" mt="4rem" mb="7rem" position="relative">
      <Box maxWidth="830px" mx="auto" mb="64px" textAlign="center">
        ...
        <FlexBox justifyContent="center" m="-0.5rem">
          ...
          <Scroll to="demos" duration={400} offset={-72 - 16} smooth>
        ...
        <Box mt={4}>
          <a href="https://forms.gle/rfLsBsHG9iX3K2nbA" target="_blank" rel="noreferrer">
            <Paragraph color="gray.600" style={{ textDecoration: 'underline', cursor: 'pointer' }}>
